...
Page({
  ...
  onPullDownRefresh : function(){
    this.data.start = 0;
    this.downDataRequest(this.data.sessionId)
  },
  ...
  upDataRequest: function (sessionid){
    var that = this;
    var sessionid = sessionid || that.data.sessionId;
    // console.log('sessionid is'+sessionid)
    var wxRequest1 = pwx.request({
    ...
    wxRequest1.then(res => {
      ...
      } else if (res.data.code == 40008 || res.data.code == 40012){
        console.log('1');
  ...
  downDataRequest : function(sessionid){
    var that = this;
    var sessionid = sessionid || that.data.sessionId;
    // console.log('sessionid is'+sessionid)
    var wxRequest1 = pwx.request({
